...
A projekt során egy pszichológus hallgatónak készítettünk egy időpontfoglaló webalkalmazást.

A projekt a következő technológiákat/szoftvereket használta a munka során: 
...
## Futtatás
- Nyiss egy terminált
- Lépj az src mappába (cd parancs)
- npm install
- npm start
- Ctrl + bal klikk a linkre
